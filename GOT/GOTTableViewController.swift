...
//
    ...
    // Function to mark favourite and save
    ...
    @IBAction func favorit_clicked(_ sender: Any) {
        ...
        let save_action = UIAlertAction.init(title: "Save", style: .default) { (action) in
            ...
            //Calling function to create the record in CoreData
...
//
    ...
    //Filling Table View with the list
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Calling image from url mentioned in Json
    ...
    //Segue passing the Character array object for further details
